...
#
#     PHX_SERVER=true bin/surrealix_demo start
#
...
if config_env() == :prod do
  ...
  config :surrealix_demo, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  #
  #     config :surrealix_demo, SurrealixDemo.Mailer,
