defmodule Surreal.Codec do
  # from: https://github.com/elixir-sqlite/ecto_sqlite3/blob/main/lib/ecto/adapters/sqlite3/codec.ex
  @moduledoc false
  ...
  def json_decode(x) when is_binary(x) do
    Application.get_env(:surrealix, :json_library, Jason).decode(x)
  end
  ...
  def json_encode(value) do
    Application.get_env(:surrealix, :json_library, Jason).encode(value)
  end
